-- SELECT DISTINCT Territory FROM MaRSDataCatalyst.RICSurveyFlat.vRevenueBySupportOrg
-- SELECT * FROM MDCReport.dbo.FactRevenue
--INSERT INTO MDCReport.dbo.FactRevenue
SELECT BatchId, CompanyID, DataSourceID, CurrentFormer,
    CASE WHEN DataSource = 'Crunchbase.Organizations' THEN 14
         ...
         WHEN DataSource = 'Reporting.vRevenueAmount' THEN 22
         WHEN DataSource = 'ThomsonReuters.DealsDetailedView' THEN 21 END as TableSource,
    CASE WHEN DataSource = 'Canada' THEN 1
         WHEN DataSource = 'Outside_of_Canada' THEN 2
         WHEN DataSource = 'Unknown' THEN 3
         WHEN DataSource = 'USA' THEN 4
         WHEN DataSource = 'Canada_excluding_Ontario' THEN 5
         WHEN DataSource = 'World_excluding_USA_Canada' THEN 6
         WHEN DataSource = 'World_excluding_Canada' THEN 7
         WHEN DataSource = 'Ontario' THEN 8 END AS Territory,
    Amount,
    ...
    CASE WHEN MaRS_program = 'Growth' THEN 1
         ...
         WHEN MaRS_program = 'Start' THEN 3 END AS MaRSProgram,MaRS_client_indicator,
    IAF_indicator, CII_indicator, Z_index, SurveyYear, CompanyName

FROM MaRSDataCatalyst.RICSurveyFlat.vRevenueBySupportOrg